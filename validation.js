$(document).ready(function () {
    ...
    function validate_post() {
        ...
        else  if ((/^[a-zA-Z]+[\s]{0,1}[a-zA-Z]+[\s]{0,1}[A-z]+/.test(post)) != true) 
        {
            $('#err_post').text("Invalid post");
            $('#err_post').fadeIn("2500").show();
    ...
    function validate_fname() {
        ...
        else  if ((/^[a-zA-Z]+[\s]{0,1}[a-zA-Z]+[\s]{0,1}[A-z]+/.test(fname)) != true) 
        {
    ...
    function validate_spname() {
        ...
        if(spname!="")
        {
            if ((/^[a-zA-Z]+[\s]{0,1}[a-zA-Z]+[\s]{0,1}[A-z]+/.test(spname)) != true) 
            {
...
$('#register').on('click',function(){
    ...
    // {
      ...
      var married=$('input[name=customRadioInline3]').val();
